...
test('buildSocketNotify emits JSON-RPC and parser handles cmux responses', () => {
  const payload = buildSocketNotify({ title: 'Done: repo', body: 'Copilot session complete' }, 'req-1')
